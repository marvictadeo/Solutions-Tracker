...
Resource             BA_Form_Keywords.resource
Resource             Solution_Tracker_Portal_Keywords.resource


*** Test Cases ***
Verify Master Data, Ticket Submission And Ticket Summary : FACE BA
    [Documentation]    Test Case to Verify FACE BA Form Master Data
    ...    Ticket Submission
    ...    Ticket Summary
    Verify Master Data, Ticket Submission And Ticket Summary : FACE BA

Verify Ticket Creation With CRM Checking : FACE BA
    [Documentation]    Test Case to Verify FACE BA Form Master Data
    ...    Ticket Submission
    ...    Ticket Summary
...
Verify BA Data And Field Validation : FACE BA
    [Documentation]    Test Case to Verify FACE BA Form Master Data
